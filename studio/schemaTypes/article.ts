...
export default defineType({
	...
	fields: [
		...
		defineField({ name: "ages", title: "גילאים מהאתר הישן", type: "array", of: [{ type: "string" }] }),
		defineField({ name: "articleTypes", title: "סוגי מאמר מהאתר הישן", type: "array", of: [{ type: "string" }] }),
		...
		defineField({ name: "instagramPostUrl", title: "פוסט / סרטון אינסטגרם", type: "url" }),
