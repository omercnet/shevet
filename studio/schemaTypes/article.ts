...
export default defineType({
  ...
  fields: [
    ...
    defineField({name: 'slug', title: 'כתובת', type: 'slug', options: {source: 'title', maxLength: 96}, validation: (r) => r.required()}),
    defineField({name: 'type', title: 'סוג', type: 'string',
      options: {list: [{title: 'מאמר', value: 'article'}, {title: 'סדנה (וידאו)', value: 'workshop'}], layout: 'radio'},
